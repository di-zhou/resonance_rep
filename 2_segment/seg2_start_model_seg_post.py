# Clean and tokenize (segment) answer post for training start model

# Use this after running the script "time_slice_posts.R" (remember to change the date range for "start model")
...
file_path_ls = [f for f in os.listdir('./data/chrono_post_startmodel/') if f.endswith(".txt")]
# Iterate through files
for path in file_path_ls:
    input_path = './data/chrono_post_startmodel/' + path
    output_path = './data/chrono_post_startmodel_seg/' + path
