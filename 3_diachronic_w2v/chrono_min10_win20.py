...
# w2v with min_count = 10, window = 20
...
'''
This uses w2v model min_count = 10 and window = 20
'''
...
for idx in range(1,len(time_slice)):
    ...
    if idx <= 1:
        previous_model_fp = './model_min10_win20/model_start.bin'
    if idx > 1:
        previous_model_fp = './model_min10_win20/model_' + time_slice[idx-2] + '.bin'
    ...
    new_model_fp = './model_min10_win20/model_' + previous_t + '.bin'
...
# save results
with open('./data/nov_stats_min10_win20.pkl', 'wb') as f:
